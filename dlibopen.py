...
while 1:
	...
	if length == 1:
		...
		for face_rect, name in zip(detected_face, face_names):
			...
			draw_rectangle(top, left, right, bottom)
			cv2.putText(frame, name, (left - 10, top - 20), font, .7, (66, 152, 243), 2, cv2.LINE_AA)

	cv2.putText(frame, 'Press \'q\' to exit', (10,20), font, 0.5, (255, 0, 0), 1, cv2.LINE_AA)
